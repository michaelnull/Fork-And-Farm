...
namespace ForkAndFarm.Controllers
{
    public class SupplyOffersController : Controller
    {
        ...
        public ActionResult Create(SupplyOffer supplyOffer)
        {
            ...
            supplyOffer.ProposedBy = currentUser.profile;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Invoice,SupplyOffer_Id,Memo,Product,Unit,Quantity,UnitPrice,ExtPrice,Delivery,PaymentTerms,CreatedOn")] SupplyOffer supplyOffer)
        {
            if (ModelState.IsValid)
            {
